...
def analyze():
    ...
    if "project" not in text:
        suggestions.append("Add Projects section to showcase your work")

    if "experience" not in text:
        suggestions.append("Add Experience section for better credibility")
    ...
    if any(s in skills for s in ["Python","Java","C++","JavaScript"]):
        if "github" not in text:
            suggestions.append("Add GitHub projects")

    if any(s in skills for s in ["Machine Learning","Data Analysis"]):
        if "project" not in text:
            suggestions.append("Add ML/Data projects")

    if any(s in skills for s in ["Content Writing","Copywriting","SEO"]):
        if "portfolio" not in text:
            suggestions.append("Add portfolio links")
